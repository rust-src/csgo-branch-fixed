...
public:
	...
	void Event_PortalPlacement(CBasePlayer*, const Vector&, PortalPlacementResult_t, bool) {};
	...
	void Event_PortalTeleport(CBasePlayer*) {}; //theaperturecat
	void Event_PlayerTaunt(CBasePlayer*, const char*) {}; //theaperturecat
	void Event_TurretDamage(float) {  };//theaperturecat
	void Event_PlayerDeath(CBasePlayer*) {};
	void Event_TractorBeam_Project(const Vector&,Vector &,CPortal_Player *) {};
